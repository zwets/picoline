...
#   Its usage pattern is as follows (see also the main() tester function below):
#
...
#
#   Listen() returns True if any job completed or failed, and False if no more
#   jobs are QUEUED or RUNNING.
#
#   This module has a main() function which can be used for simple CLI testing:
#
#       pip3 install psutil  # required module
#       python3 -m pico.jobcontrol.subproc --help
#       python3 -m pico.jobcontrol.subproc sleep $((RANDOM / 1000))
#
